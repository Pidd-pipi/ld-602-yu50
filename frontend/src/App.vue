...
const active = ref<string>(routes[1]?.route ?? "/warehouses");
...
<template>
  <div class="shell">
    ...
    <main class="page">
      <section class="page-head"><div><p class="eyebrow">rescue-stock</p><h1>{{ current?.name }}</h1></div><StatusBadge value="LOCAL_DATA" label="本地数据" tone="muted" /></section>
